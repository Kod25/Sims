...
import static org.thingsboard.common.util.DonAsynchron.withCallback;
    ...
    public class TbCalendarApiCallNode implements TbNode{
        ...
        private TbMsg calendarCall(TbMsg msg) throws TbNodeException {
           /* TbMsg tbMsg = msg;
            try {
                ...
                GoogleCredentials credentials = GoogleCredentials
                        .fromStream( new ByteArrayInputStream(config.getServiceAccountKey().getBytes()))
                        .createScoped(Collections.singleton(CalendarScopes.CALENDAR_EVENTS_READONLY));
            }catch(Exception e){
                throw new TbNodeException(e);
            }
            */
